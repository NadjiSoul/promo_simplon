	...
	if ( is_customize_preview() ) {
		...
		$settings['widgetmargin'] = array(
			...
			'margin-bottom'	=> array( '.widget' . ',' . '.frontpage-area',
									  ...
									  '.footer .widget', // brevity : replaced by newvalintsmall in js
									  '.content-block-row' . ',' . '.vcard-row', // brevity : replaced by newvalintsmall in js
									),
			'padding'		=> array( '.frontpage-area.module-bg-highlight, .frontpage-area.module-bg-color, .frontpage-area.module-bg-image' ),
			'media'			=> array(
		...
		$settings['site_title_icon_size'] = array(
			...
			'margin-left'	=> array( '.site-logo-with-icon #site-title' ),
		);
		$settings['logo_image_width'] = array(
